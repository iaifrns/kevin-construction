...
const detailServices: {
...
}[] = [
  {
    ...
    points: [
      ...
      {
        "Plans techniques":
          "Réseaux électriques, plomberie, assainissement, climatisation.",
      },
      {
        "Études de faisabilité":
          "Analyse du site, contraintes géotechniques, légales et financières.",
      },
      {
    ...
    points: [
      { "Métrés détaillés": "Calcul exact des surfaces et volumes." },
      {
        "Évaluation des coûts":
          "Unitaires des matériaux et de la main-d’œuvre.",
      },
      { "Devis transparents": "Complets, sans frais cachés." },
      {
        "Business plan stratégique":
          "Projection financière et plan d’amortissement.",
      },
      {
        "Études comparatives":
          "Pour choisir les meilleures solutions techniques et économiques.",
      },
      {
        "Accompagnement financement":
          "Aide à la recherche de financements et partenariats.",
      },
    ],
  },
  {
    ...
    points: [
      {
        "Gros œuvre":
          "Terrassement, fondations, structures béton/acier, murs porteurs.",
      },
      {
        "Maçonnerie et charpente":
          "Réalisation des structures verticales et horizontales.",
      },
      {
      ...
      {
        Finitions:
          "Enduits, plâtrerie, carrelages, faïences, résines, peintures.",
      },
      {
        Menuiseries:
          "Bois, aluminium et ferronnerie pour un rendu moderne et fonctionnel.",
      },
      {
        "Respect des délais et budgets":
          "Exécution rigoureuse selon engagements.",
      },
      {
        "Matériaux certifiés":
          "Utilisation de matériaux durables et conformes.",
      },
    ],
  },
  {
    ...
    points: [
      {
        "Rénovation intérieure":
          "Modernisation de cuisines, salles de bain, bureaux et espaces de vie.",
      },
      { "Rénovation extérieure": "Façades, toitures, aménagements paysagers." },
      {
        "Réhabilitation complète":
          "Renforcement des structures anciennes, mises aux normes électriques, plomberie et sécurité incendie.",
      },
      { Extensions: "Pour augmenter la surface habitable ou utile." },
      {
        "Respect du style architectural":
          "Intégration harmonieuse avec des technologies modernes.",
      },
      {
      ...
      },
      {
        "Optimisation énergétique":
          "Réduction de la consommation et amélioration du confort.",
      },
    ],
  },
];
