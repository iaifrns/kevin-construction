...
import WHYUS2 from "../assets/20180406_155701.jpg";
import WHYUS1 from "../assets/26991695_1981206938868614_4603266858185040058_n.jpg";
import SERVICEIMG1 from "../assets/IMG_20230128_131300_091.jpg";
...
import IMG8 from "../assets/WhatsApp Image 2025-10-09 at 19.04.57_a93e8a76.jpg";
import IMG9 from "../assets/WhatsApp Image 2025-10-09 at 19.04.58_0de23deb.jpg";
import IMG10 from "../assets/WhatsApp Image 2025-10-09 at 19.04.58_87e80e31.jpg";
...
import MINDEF1 from "../assets/mindef/SAM_2154.jpg";
import MINDEF2 from "../assets/mindef/SAM_2928.jpg";
import MINDEF3 from "../assets/mindef/SAM_2929.jpg";
import MINDEF4 from "../assets/mindef/SAM_2932.jpg";
import MINDEF5 from "../assets/mindef/ACCamera1.jpg";
import MINDEF6 from "../assets/mindef/ACCamera2.jpg";
...
const imgYassa = [YASSA6, YASSA5, YASSA3, YASSA4, YASSA2, YASSA1];

const imgTrans = [TRANS5, TRANS6, TRANS3, TRANS4, TRANS1, TRANS2];

const imgKribi = [KRIBI1, KRIBI3, KRIBI4, KRIBI2, KRIBI5, KRIBI6];

const imgPortaire = [PORT5, PORT6, PORT3, PORT4, PORT1, PORT2];

const imgJapoma = [JAPOMA5, JAPOMA4, JAPOMA3, JAPOMA1, JAPOMA2, JAPOMA6];

const imgOdza = [ODZA5, ODZA1, ODZA3, ODZA4, ODZA2, ODZA6];

const imgAwai = [AWAI4, AWAI1, AWAI5, AWAI6, AWAI3, AWAI2];

const imgVKribi = [VILLAK6, VILLAK1, VILLAK3, VILLAK4, VILLAK5, VILLAK2];

const imgHon = [HON5, HON6, HON3, HON4, HON2, HON1];
