    ...
    <div className="flex min-[500px]:w-[80%] gap-8 max-[1035px]:flex-col">
      <div className="flex flex-col gap-6 flex-2">
        ...
        <div className="p-4 border-dotted border-3 border-secondary rounded-2xl">
          ...
          >
            <div className="p-8 h-full w-full bg-[rgba(16,80,85,0.8)] rounded-2xl flex justify-center items-center flex-col">
              ...
              <div className="flex items-center gap-2">
                ...
                <p className="font-bold font-poppins max-[500px]:text-3xl text-[38px] text-white">
                  {phone}
                </p>
              </div>
            </div>
