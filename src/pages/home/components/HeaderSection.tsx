  ...
  return (
    ...
    >
      <div className="w-full h-full px-8 py-12 rounded-2xl bg-[rgba(23,80,85,0.8)] flex flex-col gap-4">
        <p className="text-white font-poppins font-bold max-[800px]:text-[42px] text-[56px]">Turn Your Dream Project into Reality</p>
        <p className="text-2xl font-semibold text-white font-poppins max-[800px]:text-xl">Talk to Our Construction Team Now.</p>
        ...
        <button className="bg-secondary text-white font-bold font-poppins px-8 py-3 rounded-4xl w-fit text-lg">Contact Us Today</button>
      </div>
    </div>
  );
};
